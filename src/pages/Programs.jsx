...
export default function Programs() {
  ...
  return (
    <div>
      <SEO
        title="Community Programs — Seva, Bharosa & Suraksha"
        description="Beyond real estate: Vijaya Developers' community programs across Vijayawada — seva, spiritual activities, trust-building with local villages and safety initiatives."
        keywords="Vijaya Developers community programs, seva Vijayawada, CSR real estate Vijayawada"
        path="/programs"
      />
      {/* Hero */}
      <section className="relative h-72 sm:h-96 overflow-hidden flex items-end">
        <img src={heroOfOurProgramsImg} alt="Vijaya Developers community programs in Vijayawada" className="absolute inset-0 w-full h-full object-cover" />
            ...
            <div className="bg-charcoal rounded-xl3 p-8 sm:p-12 text-white">
              <div className="grid lg:grid-cols-2 gap-10 items-center">
                <div>
                  ...
                  <p className="font-label text-xs uppercase tracking-widest2 text-gradient-light mb-2">Our Seva Initiative</p>
        ...
        <RevealGroup className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {others.map((p) => (
            <RevealItem key={p.title}>
              <div className="h-full bg-white border border-sand-beige rounded-xl3 p-8 hover:shadow-md transition-all">
      ...
      <section className="pb-20 max-w-7xl mx-auto px-4 sm:px-6">
        <Reveal className="text-center mb-10">
          <p className="font-label text-xs uppercase tracking-widest2 text-gradient mb-2">Seva in Action</p>
