  ...
  if (!post) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4">
        ...
        <Link to="/blogs" className="text-teal font-label font-semibold">← Back to Blogs</Link>
      </div>
    )
  }
    ...
    <div>
      ...
      <section className="relative h-80 sm:h-[28rem] overflow-hidden flex items-end">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 pb-10 text-white w-full">
          ...
          <span className="inline-block px-3 py-1 rounded-full text-xs font-label font-semibold mb-3 bg-teal text-white">
            {post.category}
          </span>
        ...
        <Reveal delay={0.1}>
          <div className="mt-12 bg-offwhite border border-sand-beige rounded-xl3 p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-5">
            ...
            <div className="flex gap-3 shrink-0">
              <a href={CONTACT.tel} className="flex items-center gap-2 px-5 py-3 rounded-full bg-teal text-white font-label font-semibold hover:bg-teal-dark transition-colors">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <Reveal className="mb-10">
            <p className="font-label text-xs uppercase tracking-widest2 text-teal mb-2">Keep Reading</p>
            ...
            {moreRelated.map((r) => (
              <RevealItem key={r.slug}>
                ...
                >
                  ...
                  <div className="p-5">
                    <p className="font-label text-xs uppercase tracking-widest2 text-teal mb-2">{r.category}</p>
